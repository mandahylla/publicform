<div class="tab-pane fade" id="nav-treating" role="tabpanel" aria-labelledby="nav-treating-tab">
            ...
            <?php foreach ($demands as $demand) : ?>
                ...
                <?php if (($demand['st_order'] === '3')) : ?>
                    ...
                    <tr>
						...
						<td><span class="badge bg-primary"><?= $demand['status']; ?></span></td>
                        <td>  
