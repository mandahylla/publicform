...
<?= $this->section('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Modifier une demande </h5>
        </div>
      	<!--  <?//= $this->include('common/alerts'); ?>-->
            <form action="<?= base_url('demand/updateDemands'); ?>" method="post" id="demandForm" enctype="multipart/form-data">
                <div class="card-body">
            ...
            <form action="<?= base_url('uploadFile/add'); ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="m-sm-5">
                        ...
                        <div class="mb-3">
                        <input type="hidden" name="demandId" value="<?= $demand['demandID'] ; ?>" id="demandId" >
                        </div>
                        <div class="mb-3"> <label class="form-label" for="inputDocType">Document à Ajouter</label>
                            <select name="inputDocType" id="inputDocType" class="form-control form-control-lg form-select form-select-lg" required>
                                  ...
                                  <option value="5">Autres Justificatifs</option>
                            </select>
                        </div>
...
$(document).ready(function () 
{
    ...
    // function docName($idName)
    // {
    //     let docType = '<div class="mb-5"> <label class="form-label" for="inputDocType'+ $idName +'">Type de Documents</label>'
    //                 + '<select name="inputDocType'+ $idName +'" id="inputDocType'+ $idName +'" class="form-control form-control-lg form-select form-select-lg" required>'
    //                             +'<option value="Passeport">Passeport (page photo)</option>'
    //                             +'<option value="Visa">Visa ou équivalent (si exigé)</option>'
    //                             +'<option value="Titre de Voyage">Titre de Voyage (Billet d\'avion)</option>'
    //                             +'<option value="Image cachet d\'entrée">Image cachet d\'entrée</option>'
    //                             +'<option value="Autres Justificatifs">Autres Justificatifs</option>'
    //                         +'</select>'
    //                     +'</div>';
    //     return docType;
    // }
...
<?= view('customer/include/demand_formjs',['demand' => $demand]); ?>
<?= $this->endSection(); ?>
